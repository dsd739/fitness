...
export default function Feed({ url, caption, likes, comments, username }) {
  ...
  // post comments like
  const postCommentLikeBtn = document.querySelectorAll(
      ...
      <div className="video-container">
        <div className="post">
          <div className="video-player">
            <video
              // poster="https://wallpapercave.com/wp/wp4273083.jpg"
              src={url}
              preload=""
              loop
          ...
          <div className="side-bar">
            {/* <div className="side-icon profile-follow">
              <div className="profile-logo">
                <img
                  src="https://assets.codepen.io/2483051/internal/avatars/users/default.png?fit=crop&format=auto&height=80&version=1636466200&width=80"
            ...
            <div className="side-icon like-btn">
              <i className="fa fa-heart-o like-icon"></i>
              <p className="like-number">{likes}</p>
            </div>

            <div className="side-icon comment-btn">
              <i className="fa fa-comment comment-icon"></i>
              <p className="comment-number">{comments}</p>
            </div>
          </div>
          <div className="post-comments ">
            <span className="close-comment">&times;</span>
            <div className="post-comments-area">
              <div className="post-comment">
                <div className="post-comment-user">
                  <img
                    src="https://assets.codepen.io/2483051/internal/avatars/users/default.png?fit=crop&format=auto&height=80&version=1636466200&width=80"
                    className="post-comment-user-img"
                    alt="xyz"
                  />
                </div>
                <div className="post-comment-content">
                  <div className="post-comment-user-name verfied">
                    <a href="https://instagram.com/sahilverma.dev">
                      sahilverma.dev
                    </a>
                    <i className="fa fa-check post-comment-user-verified"></i>
                  </div>
                  <div className="post-comment-user-msg">Amazing!!!!</div>
                </div>
                <div className="post-comment-like-btn">
                  <i className="fa fa-heart-o post-comment-like-icon"></i>
                  <p className="post-comment-like-number">9</p>
                </div>
              </div>
            </div>
            <div className="post-comment-input">
              <input
                ...
                placeholder="Enter somethings good...."
              />
              <button className="post-comment-send">
                <i className="fa fa-send send-btn"></i>
              </button>
            </div>
          </div>
          <div className="post-footer">
            <div className="username verfied">
              <a
              ...
              <i className="fa fa-check verfied-icon"></i>
            </div>
            <p className="post-description">{caption}</p>

            <div className="music-name">
              <i className="fa fa-music"></i>
              <marquee behavior="" direction="" className="song-name">
                {username}
                {"New audio........"}
              </marquee>
            </div>
          ...
          <div className="disc-logo">
            <img
              src="https://www.nicepng.com/png/detail/329-3297274_compact-disc-cd-comments-disc-icon-png.png"
              alt=""
              className="disc-logo-img"
            />
          </div>
        </div>
      </div>
